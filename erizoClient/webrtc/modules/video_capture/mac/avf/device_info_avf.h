...
#ifndef WEBRTC_MODULES_VIDEO_CAPTURE_MAC_AVF_DEVICE_INFO_AVF_H_
#define WEBRTC_MODULES_VIDEO_CAPTURE_MAC_AVF_DEVICE_INFO_AVF_H_
...
class DeviceInfoAvf : public DeviceInfoImpl {
 public:
  explicit DeviceInfoAvf(const int32_t device_id);
  virtual ~DeviceInfoAvf();
...
#endif  // WEBRTC_MODULES_VIDEO_CAPTURE_MAC_AVF_DEVICE_INFO_AVF_H_
